...
export const employeesSearchSlice = createSlice({
  ...
  reducers: {
    setSelectedEmployeeAgent: (state, action: PayloadAction<IEmployeeData[]>) => {
      state.employeeAgentSelected = action.payload;
    }
  },
...
export const { setSelectedEmployeeAgent } = employeesSearchSlice.actions;
