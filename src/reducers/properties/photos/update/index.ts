...
import { IServiceRequest, IPaginateDefault, IServiceError, IPhotoUpdatePayload, IServiceRequestStatus } from '../../../../types';
...
export const { setStatus } = propertiesPhotosUpdateSlice.actions;
